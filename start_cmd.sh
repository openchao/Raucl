...
python run_hyper.py --model=RauCL --dataset=Beauty --config_files='recbole/properties/overall.yaml recbole/properties/model/RauCL.yaml recbole/properties/dataset/sample.yaml' --params_file=1129raucl_beauty1.hyper --output_file=./hyper/1129_RauCL_Beauty1.result > ./hyper/1129Beauty1.log 2>&1
python run_hyper.py --model=RauCL --dataset=Beauty --config_files='recbole/properties/overall.yaml recbole/properties/model/RauCL.yaml recbole/properties/dataset/sample.yaml' --params_file=1129raucl_beauty2.hyper --output_file=./hyper/1129_RauCL_Beauty2.result > ./hyper/1129Beauty2.log 2>&1
python run_hyper.py --model=RauCL --dataset=Beauty --config_files='recbole/properties/overall.yaml recbole/properties/model/RauCL.yaml recbole/properties/dataset/sample.yaml' --params_file=1129raucl_beauty3.hyper --output_file=./hyper/1129_RauCL_Beauty3.result > ./hyper/1129Beauty3.log 2>&1
python run_hyper.py --model=RauCL --dataset=Beauty --config_files='recbole/properties/overall.yaml recbole/properties/model/RauCL.yaml recbole/properties/dataset/sample.yaml' --params_file=1129raucl_beauty4.hyper --output_file=./hyper/1129_RauCL_Beauty4.result > ./hyper/1129Beauty4.log 2>&1