...
class Trainer(AbstractTrainer):
    ...
    def _train_epoch(self, train_data, epoch_idx, loss_func=None, show_progress=False):
        ...
        for batch_idx, interaction in iter_data:
            ...
            # loss1,loss2 = loss_func(interaction)
            # if batch_idx%1000==0:
    ...
    @torch.no_grad()
    def calculate_uniformity(self,load_best_model=True, model_file=None, show_progress=False):
        r"""Evaluate the model based on the eval data.
        ...
        result_calculate = self.model.model_calculate_uniform()
