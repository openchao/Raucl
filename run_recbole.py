...
if __name__ == '__main__':
    ...
    parser.add_argument('--d', type=float, default=None, help='config files')
    parser.add_argument('--alpha', type=float, default=None, help='config files')
    parser.add_argument('--std', type=float, default=None, help='config files')
    parser.add_argument('--gamma', type=float, default=None, help='config files')
